    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_example', models.ImageField(blank=True, default=None, null=True, upload_to='examples/', verbose_name='Примеры работ/портфолио')),
                ('diploma', models.ImageField(blank=True, default=None, null=True, upload_to='diplomas/', verbose_name='Дипломы, сертификаты, грамоты')),
