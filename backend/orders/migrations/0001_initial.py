    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='category', to='users.industry')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.ImageField(null=True, upload_to='job_files/', verbose_name='Файлы задания')),
            ],
        ),
        migrations.CreateModel(
            name='Job',
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='users.customerprofile', verbose_name='Заказчик')),
            ],
            options={
